            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="edu-footer-widget">
                        <div class="logo">
                            <a href="index.html">
                                <img class="logo-light" src="{{asset('frontEnd')}}/assets/images/logo/logo-white.png" alt="Site Logo">
                            </a>
                        </div>
                        ...
                        <ul class="social-share">
                            <li><a href="https://www.facebook.com/shakhawathossain6"><i class="icon-Fb"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner text-center">
                        <p>Copyright 2023 <a href="#">EduVibe</a> Designed By <a href="https://shakhawath.xyz/" target="_blank">ShakaStudio</a>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
